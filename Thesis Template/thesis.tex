%convert logoPUCP.jpg -colorspace Gray output.png
%convert output.png -alpha set -channel A -evaluate set 50% output2.png
...
% ******************************** Front Matter ********************************
\begin{document}
  %%%% SI quieren fondo de pantall y colroes header footer
